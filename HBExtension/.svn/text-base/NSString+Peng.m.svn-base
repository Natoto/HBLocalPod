...
+(NSMutableAttributedString *)getStrongAttributionString:(NSMutableAttributedString *)sourcestring strongstr:(NSString *)string
{
    ...
    if (moneyRange.location!= NSNotFound) {
        [attributionstring addAttributes:@{NSForegroundColorAttributeName:[UIColor orangeColor]} range:moneyRange];
        // [UIColor redColor]
    }
...
+(NSMutableAttributedString *)getWeakAttributionString:(NSMutableAttributedString *)sourcestring weakstr:(NSString *)string
{
    ...
    NSRange moneyRange = [sourcestring.mutableString rangeOfString:string];
    if (moneyRange.location!= NSNotFound) {
        [attributionstring addAttributes:@{NSForegroundColorAttributeName:[UIColor grayColor]} range:moneyRange];
    }//[UIColor grayColor]
    return attributionstring;
}
