...
@implementation UIButton(PENGPENG)
@dynamic image;
...
////带光圈的
////    UIBezierPath *path= [UIBezierPath bezierPathWithRoundedRect:CGRectMake(1, 1, self.bounds.size.width -2, self.bounds.size.height - 2)  cornerRadius:cornerRadius - 2];\
