 ...
 * 从LUT图片中获得滤镜图片
 */
+ (SCFilter *)colorCubeWithColrLUTImageNamed:(NSString *)imageName dimension:(NSInteger)n
{
    
    UIImage *image = [UIImage imageNamed:imageName];
    
    NSData * data = [SCFilter colorCubeDataWithCGImage:image.CGImage dimension:n];
