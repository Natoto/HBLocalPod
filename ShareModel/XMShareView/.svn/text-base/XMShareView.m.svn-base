...
- (void)initUI
{
    ...
    UIView *shareActionView = [[UIView alloc] initWithFrame:CGRectMake(bgViewX,
                                                                       ...
                                                                       bgViewWidth,
                                                                       bgViewHeight)];
    _shareActionView = shareActionView;
...
-(void)show{
    ...
    self.shareActionView.transform = CGAffineTransformMakeScale(0.0008, 0.0008);
    [UIView animateWithDuration:0.5 animations:^{
        self.shareActionView.transform = CGAffineTransformMakeScale(1, 1);
        self.alpha = 1.0;
