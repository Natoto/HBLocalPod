...
@property (nonatomic, strong) NSString * viperProtocol; //viper协议名称
@property (nonatomic, strong) NSString * viperSelector; //viper协议方法
@property (nonatomic, strong) NSMutableArray * viperParams; //viper传递的参数
