...
//        NSInputStream *outputStream = self.request.HTTPBodyStream;//[[NSOutputStream alloc] initToMemory];
//        NSData *contents = [NEHTTPEye dataWithContentsOfStream:outputStream initialCapacity:51200 error:nil];
//        
//        NSLog(@"\nRequest body %@\n", [[NSString alloc] initWithData:contents  encoding:NSUTF8StringEncoding]);
//    }
