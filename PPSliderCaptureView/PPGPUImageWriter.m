...
NSString *const kPPGPUImageColorSwizzlingFragmentShaderString = SHADER_STRING
(
...
@implementation PPGPUImageWriter
...
- (id)initWithMovieURL:(NSURL *)newMovieURL size:(CGSize)newSize fileType:(NSString *)newFileType outputSettings:(NSMutableDictionary *)outputSettings;
{
    ...
    runSynchronouslyOnContextQueue(_movieWriterContext, ^{
        ...
        {
            colorSwizzlingProgram = [_movieWriterContext programForVertexShaderString:kGPUImageVertexShaderString fragmentShaderString:kPPGPUImageColorSwizzlingFragmentShaderString];
        }
